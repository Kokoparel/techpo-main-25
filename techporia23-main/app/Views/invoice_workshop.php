    ...
    <div id="invoice">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; padding: 2rem;">
            <div style="display: flex; justify-content: space-between;">
                ...
                <span
                    style="outline: 1px solid #06d000; padding: 0.2rem 1.2rem; color: #06d000; border-radius: 2px;">
                    Berhasil
                </span>
            </div>
            <div style="display: flex; justify-content: space-between;">
        ...
        <div style="padding: 0 2rem; margin-top: 2rem;">
            <p style="text-align: justify; font-size: 1rem; margin-bottom: 1.5rem;">
                Terimakasih telah bertransaksi! Pembayaran anda telah diterima dengan rincian sebagai berikut:
            </p>
            ...
            <table style="width: 100%; border-spacing: 1rem;">
                ...
                <tr>
                    ...
                    <td><?= date('F j, Y, g:i a', strtotime($transaction['transaction_time'])); ?></td>
                </tr>
            </table>
            ...
            <table style="width: 100%; border-spacing: 1rem;">
                <tr>
                    <th style="text-align: left;">Tiket Workshop Technology Euphoria <?= $data['kategori']; ?></th>
                    <td><?= $harga; ?></td>
                </tr>
                <tr>
        ...
        <p style="font-size: 0.9rem; padding: 0 1rem; text-align: justify; margin-bottom: 2rem;">
            Tiket anda telah kami kirimkan ke email anda. Jika belum menerimanya, anda bisa mendownload tiketnya
            <a href="<?= base_url('workshop/tiket/download'); ?>" style="color: #97fb57">disini</a>.
        </p>
    </div>
</div>
