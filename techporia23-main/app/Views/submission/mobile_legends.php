...
<div class="main">
  <div class="container top">
    <div class="submission-flex">
      <img src="<?= base_url('assets/images/competition-logo/ml.webp'); ?>" alt="Mobile Legends" class="logo-kompetisi-lg" />
      <div class="submission-detail">
        <h1 class="submission-title">Submission Mobile Legends</h1>
        ...
        <div class="input-wrapper">
          <label for="proposal">Upload Screenshot In-Game</label>
