...
<?= $this->section('title'); ?>Daftar Workshop | Technology Euphoria<?= $this->endSection(); ?>
...
<div class="main">
    <div class="container-form">
        ...
        <div class="input-wrapper">
            ...
            <input type="text" name="instansi" id="instansi" placeholder="Asal Instansi" />
        </div>
        <div class="input-wrapper">
